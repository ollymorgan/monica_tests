...
OUTDIR='/home/morgaol/jrcbox_staging/ROMC_Results/meyniej_dt1_0/IDL/'
PYOUTDIR='/home/morgaol/jrcbox_staging/ROMC_Results/meyniej_dt1_0/python/'
...
;exp=['HOM03_TUR_PLA_RED_20','HOM02_TUR_PLA_NR1_30', 'HOM01_TUR_ERE_NR1_30']
